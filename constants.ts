...
import { Message, ProductDef } from './types';
...
export const DEFAULT_PRODUCTS: ProductDef[] = [
  ...
  { id: 'cafe_sobres', keywords: ['sobre de cafe', 'sobres de cafe', 'sobre cafe', 'sobres', 'sobrecito'], price: 0.09, name: 'Sobre Café Riko', unit: 'sobre' },
  ...
  { id: 'soperos_indiv', keywords: ['soperos', 'sopero'], price: 0.20, name: 'Soperos (Individual)', unit: 'unidad' },
  ...
  { id: 'cubitos', keywords: ['cubito', 'cubitos'], price: 0.04, name: 'Cubitos', unit: 'unidad' },
  ...
  { id: 'chile_guaco', keywords: ['chile guaco', 'guaco'], price: 0.125, name: 'Chile guaco', unit: 'unidad' },
